...
A sub mediocre Perl web framework built on PSGI. Not meant for production use — this is a personal project to better understand how web frameworks, HTTP, and PSGI work under the hood.
